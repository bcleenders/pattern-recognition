...
\horrule{0.1pt} \\[0.1cm] % Thin top horizontal rule
\huge{Feature Extractor for Character Recognition}\\
\small{Pattern Recognition - EQ2340 Assignment 2} \\ % The assignment title
\horrule{2pt} \\[0.3cm] % Thick bottom horizontal rule
}

\author{Bram Leenders \\ \href{mailto:leenders@kth.se}{leenders@kth.se}
\and Deepa Krishnamurthy \\ \href{mailto:deepa@kth.se}{deepa@kth.se}}
